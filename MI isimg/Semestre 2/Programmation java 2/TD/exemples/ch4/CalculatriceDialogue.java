...
public class CalculatriceDialogue {
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "Bienvenue", "Jeu", JOptionPane.INFORMATION_MESSAGE);
		...
		JOptionPane.showMessageDialog(null, "Votre sexe est " + sexe[rang], "Etat civil", JOptionPane.INFORMATION_MESSAGE);
		    ...
		    try {
		    	...
		    	nombre1 = Double.parseDouble(JOptionPane.showInputDialog(null, "Veuillez entrer un nombre valide pour le premier nombre !"));
		    }
		    ...
		    try {
		    	...
		    	nombre2 = Double.parseDouble(JOptionPane.showInputDialog(null, "Veuillez entrer un nombre valide pour le second nombre !"));
		    }
...
JOptionPane.showMessageDialog(null, nombre1 + " " + operateur + " " + nombre2 + " = " + resultat);
		int reponse = JOptionPane.showConfirmDialog(null, "Êtes-vous satisfait de ce programme ?", "Satisfaction", JOptionPane.YES_NO_OPTION);
